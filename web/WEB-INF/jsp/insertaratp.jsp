<%-- 
    Document   : insertaratp
    Created on : 20-feb-2020, 11:29:55
        ...
        <%
            if(session.getAttribute("rol_user").toString().matches("2")){
                ...
                response.sendRedirect("atps.htm?msj=Emptyname");                   
                    ...
                    response.sendRedirect("atps.htm?msj=Emptycel");                   
             }
