<%-- 
    Document   : insertarjefe
    Created on : 21-feb-2020, 11:34:20
        ...
        <%
            if(session.getAttribute("rol_user").toString().matches("2")){
                ...
                response.sendRedirect("jefes.htm?msj=Emptyname");                   
                    ...
                    response.sendRedirect("jefes.htm?msj=Emptycel");                   
             }
